...
module.exports = {
    ...
    CAPTION: process.env.CAPTION || "POWERED BY THع NIGHTMARE",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M THE NIGHTMARE WHATSAPP BOT 😊♻️",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923171949741",
    OWNER_NAME: process.env.OWNER_NAME || "THع NIGHTMARE",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "THع NIGHTMARE",
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү THع NIGHTMARE`",
